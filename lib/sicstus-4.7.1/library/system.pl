...
%@  system that do not fit elsewhere.
...
%	make_directory/1,
% [PM] 4.0 now in library(file_systems) as current_directory/[1,2]
%	working_directory/2,
...
:- datime/2 is det.
:- datime/2 is documented_as(datime/1).
